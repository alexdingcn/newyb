    ...
    <div>
        <Row type="flex" justify="end">
            <ButtonGroup size="small">
                <Button type="success" :loading="savebtnLoading" icon="checkmark" @click="submitGoods">提交</Button>
            </ButtonGroup>
        </Row>
        <hr size="1" color="#e9eaec" style="position: absolute; left: 80%; width:20%;" />

        <Form :model="formItem" :rules="ruleValidate" :label-width="90" style="margin-top: 2em;">
            <Row>
                <Col span="6">
