        ...
        <Card >
            ...
            <div slot="extra">
                <ButtonGroup size="small">
                    <Button type="primary" icon="search" :loading="loading">查询</Button>
                    <Button type="success" icon="checkmark" :loading="loading" >采购审核</Button>
                    <Button type="warning" icon="checkmark-circled" :loading="loading" >质量审核</Button>
                    <Button type="error" icon="trash-a" :loading="loading" >删除</Button>
                </ButtonGroup>
            </div>
