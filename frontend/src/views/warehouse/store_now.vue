         ...
         <Row>
            <Col span="6">
                <FormItem label="仓库点" prop="warehouseId">
                    <warehouse-select v-model="storeNow.warehouseId" size="small"></warehouse-select>
                </FormItem>
            </Col>
             ...
             <Col span="3">
             <FormItem label="可售状态" >
                 <Select v-model="storeNow.sale_state" size="small"   prop="sale_state">
        ...
        <Row>
            <Col span="6">
                <FormItem label="供应商" prop="supplierId">
                    <supplier-select v-model="storeNow.supplierId" size="small"></supplier-select>
                </FormItem>
            </Col>
            <Col span="6">
